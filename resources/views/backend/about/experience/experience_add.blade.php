    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Experience View</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="col-lg-8 col-md-8">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title">Experience Manage <span class="badge badge-danger"> {{ count($experience) }} </span></h3>
                                    ...
                                    <table class="table table-hover table-striped table-border">
                                        ...
                                        @foreach($experience as $item)
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <a href="{{ route('experience.edit', $item->id) }}" class="btn btn-info btn-sm">
                                                        <i class="fas fa-pencil-alt">
                                                        </i> Edit
                                                    </a>
                                                    <a href="{{ route('experience.delete', $item->id) }}" class="btn btn-danger btn-sm">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('experience.store') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="experience_name" class="form-control" placeholder="Enter experience name">
                                    </div>
